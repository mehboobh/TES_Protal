...
export default function InsurancePage() {
  ...
  const companyId = params.id // Pulls the exact ID from the URL (e.g., CMP-33889)
  ...
  return (
    <div className="space-y-6 pb-10">
      <PageHeader
        ...
        description={`Manage transportation liability, workers' compensation, and surety bonds for ${companyId}.`}
        actions={
